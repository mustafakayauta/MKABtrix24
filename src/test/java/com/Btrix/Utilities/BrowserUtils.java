...
public class BrowserUtils {
    ...
    public static void executeJScommand(String command) {
        JavascriptExecutor jse = (JavascriptExecutor) com.Btrix.Utilities.Driver.getDriver();
...
//        String target = "/Users/studio2/IdeaProjects/Spring2019FinalTestNGFramework/screenshots/" + name + date + ".png";
    ...
    public static void waitForPresenceOfElement(By by, long time) {
        new WebDriverWait(com.Btrix.Utilities.Driver.getDriver(), time).until(ExpectedConditions.presenceOfElementLocated(by));
    }
